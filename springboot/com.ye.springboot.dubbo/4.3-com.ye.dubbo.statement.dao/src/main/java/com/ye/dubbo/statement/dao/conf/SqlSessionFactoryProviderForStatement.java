 ...
 */
@Configuration
public class SqlSessionFactoryProviderForStatement {
    @Autowired
     ...
     */
    @Bean(name = "StatementSqlSessionFactory")
    public SqlSessionFactory statementSqlSessionFactory(@Qualifier("sqlDbStatementDataSource")DataSource ds) throws Exception {
